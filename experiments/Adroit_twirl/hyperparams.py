...
EXP_DIR = BASE_DIR + '/../experiments/Adroit_twirl/'
...
agent = {
    'type': AgentMuJoCo,
    'filename': './mjc_models/Adroit/Adroit_hand(twirl)131.xml',
    'x0': x0_init,
    'dt': 0.05,
    'substeps': 25,
...
cost_wt[24:27] = 1.0
cost_wt[27:30] = [10, 5, 5]

cost_tgt = copy.copy(x0_init)[:30]
cost_tgt[27:30] = [0, 0, np.pi];

#data_logger = DataLogger()
#traj_samples = data_logger.unpickle('/home/abhigupta/vikash_gps_backup2/experiments/Adroit_twirl/data_files/traj_sample_itr_15.pkl')
#cost_tgt = traj_samples[0]._samples[0].get(JOINT_ANGLES)
#cost_wt = np.ones((30,))
# cost_wt[27:30] = [10.0, 5.0, 5.0]
#import IPython
#IPython.embed()
state_cost = {
    'type': CostState,
